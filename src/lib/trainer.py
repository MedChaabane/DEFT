...
class ModleWithLoss(torch.nn.Module):
  ...
  def forward(self, batch):
    ...
    x = self.model.AFE(FeatureMaps_pre, FeatureMaps_next, batch['bboxes_pre'] , batch['bboxes_next'])
    loss_pre, loss_next, loss_similarity, loss_matching, accuracy_pre, accuracy_next, accuracy, predict_indexes = self.model.AFE.loss(x, batch['labels'], batch['current_indexes'], batch['next_indexes'])
